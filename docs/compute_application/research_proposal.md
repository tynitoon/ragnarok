...
**What this means for the research program.** Branch C of the preregistered decision tree (`preregistration.md` §13 v3.7, kill clause → pivot) activates as specified. The workshop-paper-on-primary-pair path is abandoned. The program pivots to the broader three-question exploration (Q1/Q2/Q3 described in §1 above and in `reviews/research_directions.md`), where this negative result becomes informative:
