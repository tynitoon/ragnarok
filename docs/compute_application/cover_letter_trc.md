...
**The current empirical state** (2026-04-18): the preregistered primary hypothesis has been falsified at N=10. Band C extension (seeds 47–56 pooled) landed at RMST ratio **1.036**, log-rank p=0.510, leave-one-out minimum 0.871. All three pre-committed Band C kill criteria (specified at SHA `a0c1140` on 2026-04-17, before seeds 52–56 launched) triggered simultaneously. The project has activated branch C of its pre-registered decision tree: the workshop paper via primary pair is abandoned, and the program pivots to the broader three-question research agenda (Q1 physics-grounded world-model representations, Q2 contextual skill selection, Q3 transfer acceleration beyond naive `load_state_dict`). See `preregistration.md` §13 v3.8 for the kill amendment and `reviews/research_directions.md` §6 for the branch-C operational roadmap.

This outcome is a *feature* of the methodology, not a failure mode. Preregistered kill criteria exist precisely to fire when they should, and this one did. The methodology infrastructure that enabled the kill — preregistration, chronology audit, multi-agent adversarial reviews, seed-level data in git — is itself part of what the TRC compute would support in the next phase.
