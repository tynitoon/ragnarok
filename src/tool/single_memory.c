...
const static void*				g_impossible_address = (void*)sizeof(void*);	//Impossible address, it used to detect a free element
...
{
	if (g_main_mutex == NULL)
		g_main_mutex = CreateMutex(NULL, FALSE, NULL);
}
